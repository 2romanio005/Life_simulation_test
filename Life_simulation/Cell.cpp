...
void Cell::draw_myself(HDC hdc)
{
	...
	if (this->creature != nullptr) {
		...
		if (this->creature == peep_—reature) {
...
void Cell::set_Creature(—reature* creature)
{
	if (this->creature != nullptr) {
		if (this->creature != peep_—reature) {
